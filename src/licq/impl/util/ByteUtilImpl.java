...
import licq.util.ImplFactory;
import licq.util.Base64Util;
import licq.util.ByteUtil;

public final class ByteUtilImpl implements ByteUtil{
...
//2)字节数组与base64字符串间转换
    public byte[] base64ToBytes(String s){
        return ImplFactory.getBean(Base64Util.class).decode(s.getBytes());
//		return Convert.FromBase64String(s);
    }

    public String bytesToBase64(byte[] b){
        return new String(ImplFactory.getBean(Base64Util.class).encode(b));
